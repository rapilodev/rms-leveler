...
#ifndef ebur128_monitor_out
#define ebur128_monitor_out
...
const char *LOG_ID = "lufs-out";

const static LADSPA_Descriptor mon_ladspa_descriptor = { .UniqueID = 0x22b306,
    .Label = "ebur128_monitor_out", .Name = "EBU R128 Monitor Out",
