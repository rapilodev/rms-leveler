...
static LADSPA_Descriptor c_ladspa_descriptor = { .UniqueID = 0x22b3e5, .Label = "ebur128_limiter_3s", .Name =
        "EBU R128 limit -20dBFS, stereo, 3 seconds", .Maker = "Milan Chrobok", .Copyright = "GPL 2 or 3", .PortCount = 4,
