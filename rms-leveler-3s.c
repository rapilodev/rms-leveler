...
#ifndef rms_leveler_3s
#define rms_leveler_3s
...
static LADSPA_Descriptor c_ladspa_descriptor = { .UniqueID = 0x22b311,
    .Label = "rms_leveler_3s", .Name = "RMS leveler -20dBFS, 3 seconds window",
