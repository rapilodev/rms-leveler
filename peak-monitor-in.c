...
#ifndef peak_monitor_in
#define peak_monitor_in
...
const static LADSPA_Descriptor c_ladspa_descriptor = { .UniqueID = 0x22b307,
    .Label = "peak_monitor_in", .Name = "PEAK Monitor In",
