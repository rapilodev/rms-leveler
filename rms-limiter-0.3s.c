...
const double BUFFER_DURATION1 = 0.1;
...
static LADSPA_Descriptor c_ladspa_descriptor = { .UniqueID = 0x22b3e5, .Label = "rms_limiter_0.3s", .Name =
        "RMS limiter -20dBFS, stereo, 0.3 seconds window", .Maker = "Milan Chrobok", .Copyright = "GPL 2 or 3", .PortCount = 4,
